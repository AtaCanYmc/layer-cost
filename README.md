...
- 🧵 **Extensive Hardware & Filament Presets**:
  - **Printers**: Bambu Lab (X1C, P1S, A1 Mini), Creality (Ender 3 V3, K1 Max), Prusa (MK4S, Mini+), Formlabs resin.
  - **Filaments**: PLA, PLA+, PETG, ABS, TPU, ASA, Resin with automatic spool usage meters.
